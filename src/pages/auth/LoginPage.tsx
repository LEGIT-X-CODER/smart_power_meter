    ...
    <div className="min-h-screen bg-[#040d1a] flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-sm animate-slide-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Smart Power Meter</h1>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium py-3 px-6 rounded-xl transition-all duration-200 active:scale-95"
          >
            {googleLoading ? (
              <Spinner size="sm" />
            ) : (
